...
<div class="public_gallery">
        <?php for($i = 0; $i < count($vars['photos']); $i++) {?>
            <div class="img_card img_card_<?php echo $vars['photos'][$i]['id']?>">
                <div class="img_head">
                        <?php
                        ...
                        <?php if($vars['photos'][$i]['login'] === $_SESSION['authorize']['name']) { ?>
                            <div class="del">
                                <input type="button" class="delete" id="delete_<?php echo $vars['photos'][$i]['id']?>"  onclick="deleteCard(event)">
                            </div>
                        <?php } ?>
                </div>
